...
description_long: |
  ...
  Datenfluss, Invarianten und Persistenz. Architektur-Tiefe in multiwindow-architecture.md.
...
- **`multiwindow-architecture.md`** (dieses Verzeichnis) — Detail-Architektur, Sequenzen,
  Edge-Cases.
