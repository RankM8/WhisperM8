...
| [`04-whisperm8-integration-stand.md`](04-whisperm8-integration-stand.md) | Wie WhisperM8 Claude Code aktuell startet, indexiert, tracked (Agent View = `claude agents` Tab) |
| [`05-beratung-optionen.md`](05-beratung-optionen.md) | **Beratung** — welche Integrations-Wege haben wir, Pros/Cons, klare Empfehlung |
