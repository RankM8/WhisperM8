...
> ⚠️ HISTORISCH (Stand vor Refactor 2026-07-06) — Inhalte beschreiben die alte Seite; neue Seite: `RecordingSettingsPage.swift`, `ContextPrivacySettingsPage.swift` und `GeneralSettingsPage.swift` + Doku-Verweis [ARCHITEKTUR: Kompatibilitätsvertrag](../../features/settings/ARCHITECTURE.md#kompatibilitätsvertrag).
