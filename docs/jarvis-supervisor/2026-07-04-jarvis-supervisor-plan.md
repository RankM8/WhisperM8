...
- `docs/Claude Code Dokumentation/04-whisperm8-integration-stand.md` — aktueller Stand der Claude/Codex-Agent-Integration.
- `docs/Claude Code Dokumentation/05-beratung-optionen.md` — strategische Bewertung für Agent View, Background Agents und WhisperM8-Integration.
- `docs/Claude Code Dokumentation/03-hooks-sdk.md` — Kontext zu Claude Hooks, MCP, SDK, Sub-Agents.
- `docs/agent-chats-redesign/README.md` — UX-/Redesign-Kontext der Agent-Chats-Welt.
